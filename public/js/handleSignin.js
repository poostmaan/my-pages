...
function mostrarErroresComoAlertasConRetraso(errores) {
  ...
  errores.forEach((error, index) => {
    ...
    alertDiv.classList.add('alert', 'alert-danger', 'my-2', 'animate__animated', 'animate__backInRight');
...
function handleSubmit(e) {
    ...
    signin(Object.fromEntries(userForm));
    console.log(Object.fromEntries(userForm));
}
